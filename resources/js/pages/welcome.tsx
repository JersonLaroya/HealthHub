            ...
            <div className="flex justify-center lg:justify-end">
              {logoSrc ? (
                <img
                  src={`/storage/${logoSrc}`}
                  alt="System logo"
                  className="max-h-72 xl:max-h-96 w-auto object-contain animate-float transition-transform duration-500 hover:scale-[1.03]"
                />
              ) : (
        ...
        <div className="mx-auto max-w-6xl px-6 py-10">
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">University Health Services</p>
            </div>
            <div>
              <h4 className="font-medium mb-3">System</h4>
              <p className="text-sm text-muted-foreground">{system?.app_name || "HealthHub"}</p>
