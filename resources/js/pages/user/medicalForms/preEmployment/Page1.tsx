...
export default function PreemploymentPage1({ patient }: Props) {
    ...
    return (
        <AppLayout>
            <Head title="Pre-employment – Page 1" />
                ...
                <form onSubmit={submitPage} className="space-y-6">
                    ...
                    <div className="text-sm leading-relaxed text-center">
                        ...
                        <p className="mx-auto max-w-3xl">
                            ...
                            and stored with the utmost care for the purpose of pre-employment
                            health assessment and screening, adhering to ethical guidelines
                            to enhance workplace safety and employee well-being.
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-4">
                        ...
                        <div className="flex items-start justify-center gap-2 mt-1 text-sm">
                            ...
                            <span className="max-w-3xl text-left">
                                ...
                                necessary treatment required for pre-employment clearance.
                            </span>
                        </div>
                    </div>
